        ...
        <dialog data-modal>
            ...
            <form action="<?=htmlspecialchars(base_url . "Curso/add")?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3"> 
                    ...
                    <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none " aria-describedby="curso_help" id="curso_img" name="img" type="file" required>
